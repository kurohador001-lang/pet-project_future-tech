...
Проект состоит из _6 страниц_ и ориентирован на разработку UI-компонентов на **чистом JavaScript**, применение **BEM-методологии**, обеспечение **accesibility** и построение **продуманной архитектуры**.
