...
Проект состоит из _6 страниц_ и ориентирован на разработку UI-компонентов на **чистом JavaScript**, применение **BEM-методологии**, обеспечение **accessibility** и построение **продуманной архитектуры**.
## :jigsaw: Реализованные компоненты

| Компонент | Описание |
|-----------|----------|
| **Кастомный селект** | Полностью стилизованный выпадающий список с поддержкой клавиатуры |
...
### Список исправлений деталей макета:
  ...
  3. В форме на странице контактов выделены поля, обязательные для заполнения
  4. Placeholder-подсказки в форме на странице контактов переработаны с учётом UX
