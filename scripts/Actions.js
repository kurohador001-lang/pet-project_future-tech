...
class Actions {
	...
	constructor(rootElement) {
		...
		this.likeButtonElement = rootElement.querySelector(this.selectors.likeButton)
	...
	onlikeButtonClick = () => {
		...
		this.likeButtonElement.setAttribute(this.stateAttributes.title, isActive ? 'Dislike' : 'Like')
		this.likeButtonElement.setAttribute(this.stateAttributes.ariaLabel, isActive ? 'Dislike' : 'Like')
	}
